...
<html class="no-js">
	...
	<body>
		<div class="admin-biaogelist" style="text-align: center;">
			...
			<div class="listbiaoti am-cf">
				<ul class="am-icon-users on"> 用户列表</ul>
				...
				<dl>
					<button type="button" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus btn_createRoom"> 新增用户</button>
				</dl>
		...
		<script type="text/javascript">
			function queryAllPerson(pageNum, pageSize) {
				...
				$("#changeDiv").load(
						"admin_userlistpage?pageNum="+pageNum+"&pageSize="
								+ pageSize);
		...
		<div class="chuangkou chuangkou_roomadd">
			<div class="ckcontent">
			<input id="chuangkou_userid" type="hidden" value="1">
				<h4 id="chuangkou_name"></h4>
				<div class="am-input-group">
					<span class="am-input-group-label">用户昵称</span>
					<input id="chuangkou_username" type="text" class="am-form-field" placeholder="请输入用户昵称">
				</div>
				<div class="am-input-group">
					<span class="am-input-group-label">用户类别</span>
					<select id="chuangkou_userlb" class="am-form-field">
						<option value="各省校友" data-value = "123">普通用户</option>
						<option value="学院聊天室">管理员</option>
					</select>
				</div>
				<div class="am-input-group">
					<span class="am-input-group-label">注册邮箱</span>
					<input id="chuangkou_useremail" type="text" class="am-form-field" placeholder="请输入用户邮箱">
				</div>
	...
	<script src="../assets/admin/js/page/admin_userlist.js" type="text/javascript" charset="utf-8"></script>
</html>
